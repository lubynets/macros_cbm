...
void pfs_qa(const std::string& filelist){
  ...
  SimpleCut cut_0    = EqualsCut("Candidates.bg_type", 0);
  SimpleCut cut_11   = EqualsCut("Candidates.bg_type", 11);
  SimpleCut cut_121  = EqualsCut("Candidates.bg_type", 121);
  SimpleCut cut_122  = EqualsCut("Candidates.bg_type", 122);
  SimpleCut cut_13   = EqualsCut("Candidates.bg_type", 13);
  SimpleCut cut_20   = EqualsCut("Candidates.bg_type", 20);
  SimpleCut cut_21   = EqualsCut("Candidates.bg_type", 21);
  SimpleCut cut_22   = EqualsCut("Candidates.bg_type", 22);
  SimpleCut cut_30   = EqualsCut("Candidates.bg_type", 30);
  SimpleCut cut_311  = EqualsCut("Candidates.bg_type", 311);
  SimpleCut cut_312  = EqualsCut("Candidates.bg_type", 312);
  SimpleCut cut_3131 = EqualsCut("Candidates.bg_type", 3131);
  SimpleCut cut_3132 = EqualsCut("Candidates.bg_type", 3132);
  SimpleCut cut_314  = EqualsCut("Candidates.bg_type", 314);
  SimpleCut cut_321  = EqualsCut("Candidates.bg_type", 321);
  SimpleCut cut_322  = EqualsCut("Candidates.bg_type", 322);
  SimpleCut cut_3231 = EqualsCut("Candidates.bg_type", 3231);
  SimpleCut cut_3232 = EqualsCut("Candidates.bg_type", 3232);
  SimpleCut cut_324  = EqualsCut("Candidates.bg_type", 324);
...
//   };
  ...
  std::vector<QaSetup> qasetups {
    ...
    {"Bckgr", bckgrcut},
    {"signal", cut_0  },
    {"different_mothers", cut_11 },
    {"different_decay_PDG_3122or310", cut_121 },
    {"different_decay_PDG_nor3122no310", cut_122 },
    {"not_decay_process", cut_13 },
    {"both_daughters_primary", cut_20 },
    {"neg_daughter_primary", cut_21 },
    {"pos_daughter_primary", cut_22 },
    {"both_daughters_unmatched", cut_30 },
    {"pos_unmatched__neg_prim", cut_311},
    {"pos_unmatched__same_pdg", cut_312},
    {"pos_unmatched__diff_pdg_3122or310", cut_3131},
    {"pos_unmatched__diff_pdg_nor3122no310", cut_3132},
    {"pos_unmatched__neg_not_from_decay", cut_314},
    {"neg_unmatched__pos_prim", cut_321},
    {"neg_unmatched__same_pdg", cut_322},
    {"neg_unmatched__diff_pdg_3122or310", cut_3231},
    {"neg_unmatched__diff_pdg_nor3122no310", cut_3232},
    {"neg_unmatched__pos_not_from_decay", cut_324}
  };
