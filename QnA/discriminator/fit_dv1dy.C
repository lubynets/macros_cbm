...
//   rangestoslice.at(0) = {0, 6, 10, 15, 20, 30, 40, 70};
  ...
  std::string evegen, pbeam, pdg, cuts, is_fine_pt;

  if(iSetup==1) {evegen = "dcmqgsm"; pbeam = "12";  midrapidity = 1.6217901;}
  if(iSetup==2) {evegen = "dcmqgsm"; pbeam = "3.3"; midrapidity = 0.985344; }
  if(iSetup==3) {evegen = "urqmd";   pbeam = "12";  midrapidity = 1.6217901;}
